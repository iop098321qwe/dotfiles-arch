_atuin() {
    ...
    do
        case "${cmd},${i}" in
            ...
            atuin__help__import,nu-hist-db)
                ...
                ;;
            atuin__help__import,powershell)
                cmd="atuin__help__import__powershell"
                ;;
            ...
            atuin__import,nu-hist-db)
                ...
                ;;
            atuin__import,powershell)
                cmd="atuin__import__powershell"
                ;;
            ...
            atuin__import__help,nu-hist-db)
                ...
                ;;
            atuin__import__help,powershell)
                cmd="atuin__import__help__powershell"
                ;;
    ...
    case "${cmd}" in
        ...
        atuin__help__import__nu__hist__db)
            ...
            return 0
            ;;
        atuin__help__import__powershell)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        atuin__import__help__nu__hist__db)
            ...
            return 0
            ;;
        atuin__import__help__powershell)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
